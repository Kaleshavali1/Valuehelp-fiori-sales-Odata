		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ustsdsalesordsalesord-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ustsdsalesordsalesord-display": {
								"semanticObject": "ustsdsalesordsalesord",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ust.sd.salesord.salesord",
									"url": sap.ui.require.toUrl("ust/sd/salesord/salesord")
								}
							}
						}
					}
